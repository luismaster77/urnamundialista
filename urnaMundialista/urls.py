...
urlpatterns = [
    ...
    url(r'^jugador/(?P<pk>\d+)/detail/$', views.JugadorDetailView.as_view(), name='jugador-detail'),
    ...
    #Delete
    url(r'^jugador/(?P<pk>\d+)/delete/$', views.JugadorDelete.as_view(), name='jugadores-delete'),
    #Reservar
    #url(r'^jugador/votado/$', views.JugadorVotado.as_view(), name='votar'),
]